...
const handleSubmit=(e)=>{
 ...
 .then(()=>{
  ...
  return (
     <>
    <div>
    <div className="login-page" style={{background:"pink", marginTop:"15px", textAlign:"center", width:"350px", height:"350px",marginLeft:"280px",boxShadow:"rgba(0, 0, 0, 0.35) 0px 5px 15px"}}>
      <br/>
      <br/>
