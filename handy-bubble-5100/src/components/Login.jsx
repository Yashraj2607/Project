...
const handleSubmit=(e)=>{
 ...
 .then(()=>{
  ...
  return (
    ...
    <div className="login-page" style={{ padding:"10px", borderRadius:"10px", marginTop:"0px", background: "linear-gradient(90deg, rgba(253,29,29,0.5803571428571428) 24%, rgba(252,176,69,0.5551470588235294) 74%)", marginTop:"0px", textAlign:"center", width:"350px", height:"350px",marginLeft:"280px",boxShadow:"rgba(0, 0, 0, 0.35) 0px 5px 15px"}}>
    <br/>
      <br/>
