  ...
  return (
    ...
    <div className="login-page" style={{ background: "linear-gradient(90deg, rgba(253,29,29,0.5803571428571428) 24%, rgba(252,176,69,0.5551470588235294) 74%)", marginTop:"15px", textAlign:"center", width:"350px", height:"350px",marginLeft:"280px",boxShadow:"rgba(0, 0, 0, 0.35) 0px 5px 15px"}}>
      ...
      <form className="form" data-testid="login-form" onSubmit={handleSubmit}>
        ...
        <div>
          <button data-testid="form-submit" type="submit" disabled={isDisabled} style={{background:"rgb(240, 239, 239)"}}>
            SUBMIT
          </button>
        </div>
      </form>
